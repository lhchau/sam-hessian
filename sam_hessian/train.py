...
parser.add_argument('--condition1', default=None, type=float, help='SAM Atomy condition number')
parser.add_argument('--condition2', default=None, type=float, help='SAM Atomy condition number')
