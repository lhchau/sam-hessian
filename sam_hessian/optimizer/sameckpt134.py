    ...
    def second_step(self, zero_grad=False):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                d_p = p.grad.mul( mask ).div( self.condition ) + p.grad.mul( torch.logical_not( mask ) ).mul( self.condition )
